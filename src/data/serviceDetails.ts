...
export const serviceDetails: Record<string, ServiceDetail> = {
  "asthma-management": {
    ...
    description:
      "Asthma is a chronic respiratory condition that causes inflammation and narrowing of the airways, leading to breathing difficulties. Our comprehensive asthma management program combines advanced diagnostics, personalized treatment plans, and ongoing monitoring to help you achieve optimal asthma control and improve your quality of life.",
    causes: [
    ...
    image: "/src/assets/clinic-interior.png",
  },
  "allergy-testing": {
    id: "allergy-testing",
    icon: Heart,
    ...
    description:
      "Allergies occur when your immune system reacts to substances that are usually harmless. Our comprehensive allergy testing and treatment services help identify your specific triggers and provide effective management strategies through advanced testing methods and personalized immunotherapy.",
    causes: [
  ...
  "copd-care": {
    ...
    description:
      "COPD is a progressive lung disease that makes breathing difficult due to damaged airways and lung tissue. Our comprehensive COPD care program focuses on slowing disease progression, managing symptoms, and improving quality of life through advanced therapies and personalized treatment plans.",
    causes: [
  ...
  "sleep-disorders": {
    ...
    description:
      "Sleep disorders, particularly sleep apnea, can significantly impact your health and quality of life. Our specialized sleep disorder program offers comprehensive evaluation and treatment for sleep-related breathing problems using advanced diagnostic tools and evidence-based therapies.",
    causes: [
  ...
  "pulmonary-function": {
    ...
    description:
      "Pulmonary function tests (PFTs) are essential diagnostic tools that measure how well your lungs work. These comprehensive tests help diagnose respiratory conditions, monitor disease progression, and evaluate treatment effectiveness using state-of-the-art equipment.",
    causes: [
  ...
  "bronchitis-treatment": {
    ...
    description:
      "Bronchitis is inflammation of the bronchial tubes that carry air to your lungs. Our comprehensive treatment approach addresses both acute and chronic bronchitis with personalized medication plans and respiratory therapy to help you recover quickly and prevent complications.",
    causes: [
  ...
  "interstitial-lung": {
    ...
    description:
      "Interstitial lung diseases (ILD) are a group of disorders causing progressive scarring of lung tissue. Our specialized program offers expert diagnosis, monitoring, and treatment of various ILDs using advanced diagnostic techniques and cutting-edge therapies.",
    causes: [
  ...
  "smoking-cessation": {
    ...
    description:
      "Quitting smoking is one of the best things you can do for your health. Our comprehensive smoking cessation program combines counseling, medication management, and ongoing support to help you quit successfully and stay smoke-free for life.",
    causes: [
  ...
  immunization: {
    ...
    description:
      "Immunizations are crucial for preventing respiratory infections that can seriously impact lung health. Our comprehensive immunization services include flu shots, pneumonia vaccines, and other respiratory-related vaccinations to protect you from preventable diseases.",
    causes: [
  ...
  "occupational-lung": {
    ...
    description:
      "Occupational lung diseases develop from prolonged exposure to harmful substances in the workplace. Our specialized program provides expert evaluation, management, and workplace accommodation guidance for various work-related respiratory conditions.",
    causes: [
