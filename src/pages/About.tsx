...
import hospitalSMVS from "@/assets/hospital-smvs.png";
import hospitalPulmoOne from "@/assets/hospital-pulmo-one.png";
import hospitalNamostute from "@/assets/hospital-namostute.png";
...
const About = () => {
  const education = [
    ...
    },
    {
      ...
      year: "October 2022",
      description:
        "School of Interventional Pulmonology under Dr. Nitin Abhyankar",
    },
  ];
  ...
  const affiliations = [
    ...
    },
    {
      ...
      image: hospitalPulmoOne,
    },
    {
      id: 4,
      name: "Kalol Civil Hospital",
  ...
  const achievements = [
    {
      ...
      description:
        "For Securing Highest Rank in MD Respiratory Medicine Examination in entire Gujarat, 2021",
      highlight: true,
    },
    {
      icon: BookOpen,
      ...
      description:
        '"A study of resolution of chest X-ray (PA View) opacity in community acquired pneumonia" - NATCON 2020, Published in IJSR (2021)',
    },
    {
      icon: Users,
      title: "Extensive Clinical Experience",
      description:
        "1.5 years COVID-19 ICU/Ward experience, 3 years Resident Doctor, 6+ months ICU Registrar",
    },
  ];
  ...
  const timeline = [
    ...
    },
    {
      ...
      description:
        "Respiratory Medicine Department at SMIMER, Surat (3 years) including 1.5 years COVID-19 ICU, ward and OPD experience",
    },
    {
      year: "2021",
      title: "M.D. Respiratory Medicine (Gold Medalist)",
      description:
        "SMIMER / VNSGU, Gujarat - Secured Highest Rank in entire Gujarat",
    },
    {
      year: "2021",
      title: "Fellowship in Bronchoscopy",
      description:
        "Tata Memorial Hospital, Mumbai - Basic bronchoscopy procedures",
    },
    {
      year: "2021",
      title: "FAAI Fellowship",
      description:
        "Vydehi Institute, Bangalore - Allergy, Asthma and Immunotherapy",
    },
    {
      year: "2021-2022",
    ...
    },
    {
      ...
      description:
        "Fellowship in Echocardiography at CIMS Hospital, Ahmedabad & Certified Training in Respiratory Allergy at VPCI, Delhi",
    },
    {
      year: "2022",
      title: "Advanced Interventional Pulmonology",
      description:
        "Fellowship at Poona Hospital & Research Centre, Pune under Dr. Nitin Abhyankar",
    },
    {
      year: "Present",
      title: "Pulmo One Lung Care & Allergy Center",
      description:
        "Providing comprehensive respiratory and allergy care services",
    },
  ];
    ...
    <div className="min-h-screen">
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="animate-fade-in">
              <Carousel className="w-full max-w-md mx-auto flex justify-center items-center">
                <CarouselContent>
                  <CarouselItem>
                    <img
            ...
            <div className="animate-fade-in-up">
              ...
              <p className="text-lg text-muted-foreground font-medium mb-4">
                Board-Certified Pulmonologist | Interventional Pulmonology |
                Allergy & Asthma Specialist
              </p>
              <p className="text-muted-foreground leading-relaxed mb-6">
                Dr. Jaimin Patel is a highly accomplished pulmonologist with
                extensive training in advanced interventional pulmonology,
                allergy, and critical care. As a Gold Medalist in MD Respiratory
                Medicine, he brings exceptional expertise in managing complex
                respiratory conditions, performing advanced bronchoscopic
                procedures, and providing comprehensive allergy care.
              </p>
              <Card className="bg-primary/5 border-primary/20">
                <CardContent className="p-6">
                  ...
                  <p className="text-muted-foreground italic leading-relaxed">
                    "My mission is to help every patient breathe better and live
                    fuller lives. I believe in treating not just the condition,
                    but the whole person, with empathy, expertise, and
                    evidence-based care."
                  </p>
                </CardContent>
              </Card>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4 lg:px-8">
          ...
          <div className="relative rounded-[2rem] p-[3px] bg-[linear-gradient(90deg,hsl(var(--primary)),hsl(var(--accent)),hsl(var(--primary)))] bg-[length:250%_250%] animate-gradient-x shadow-[0_0_30px_rgba(0,0,0,0.2)]">
            {/* Inner panel */}
            <div className="bg-background rounded-[calc(2rem-3px)] p-10 relative z-10">
              ...
              <div className="space-y-6 max-w-6xl mx-auto">
                ...
                <div className="grid md:grid-cols-2 gap-6 animate-fade-in-up">
                  {education.slice(0, 2).map((item, index) => (
                    <Card
                      key={index}
                      className={`border-border hover:shadow-strong transition-all ${
                        item.highlight
                    ...
                    {education.slice(2).map((item, index) => (
                      ...
                      >
                        <CardContent className="p-5">
                          ...
                          <p className="text-xs text-primary font-semibold mb-2 text-center">
                            {item.year}
                          </p>
            ...
            {timeline.map((item, index) => (
              ...
              >
                <div className="flex flex-col items-center">
                  <div
                    className={`flex items-center justify-center rounded-full bg-gradient-primary shadow-medium flex-shrink-0
          ${
            item.year.length > 5
              ? "w-14 h-14 text-[0.65rem]"
              : "w-12 h-12 text-xs"
          }`}
                  >
      ...
      <section className="py-20">
        <div className="container mx-auto px-4 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16 animate-fade-in">
            ...
            <p className="text-muted-foreground text-lg">
              Recognized for academic excellence and contributions to medical
              research
            </p>
          </div>
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto animate-fade-in-up">
            {achievements.map((item, index) => (
              <Card
                key={index}
                className={`border-border hover:shadow-strong transition-all text-center ${
                  item.highlight
                    ? "ring-2 ring-primary/30 bg-gradient-subtle"
                    : ""
                }`}
              >
                <CardContent className="p-8">
                  <div
                    className={`w-16 h-16 mx-auto mb-4 rounded-full flex items-center justify-center shadow-medium ${
                      item.highlight
                        ? "bg-gradient-primary animate-scale-in"
                        : "bg-gradient-primary"
                    }`}
                  >
              ...
              <CardContent className="p-8 lg:p-12">
                <div className="flex items-start space-x-6 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground leading-relaxed mb-6">
                      Dr. Jaimin Patel has contributed to medical research
                      through publications in peer-reviewed journals and
                      presentations at national conferences. His research
                      focuses on improving diagnostic and treatment approaches
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <p className="text-sm text-foreground">
                      <span className="font-semibold">
                        "A study of resolution of chest X-ray (PA View) opacity
                        in community acquired pneumonia"
                      </span>{" "}
                      - Presented at NATCON 2020
                    </p>
                  </div>
                  <div className="flex items-start space-x-3">
                    <div className="w-6 h-6 rounded-full bg-primary/10 flex items-center justify-center flex-shrink-0 mt-0.5">
                    ...
                    <p className="text-sm text-foreground">
                      Published in IJSR - International Journal of Scientific
                      Research (2021)
                    </p>
                  </div>
                </div>
